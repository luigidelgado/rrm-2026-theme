...
if ( ! function_exists( 'storefront_sorting_wrapper' ) ) {
	...
	function storefront_sorting_wrapper() {
		echo '<div class="rrm-sorting"><div class="storefront-sorting">';
	}
}
...
if ( ! function_exists( 'rrm_content_wrapper_before' ) ) {
	/**
	 * Sorting wrapper close
	 *
	 * @since   1.4.3
	 * @return  void
	 */
	function rrm_content_wrapper_before() {
		echo '<div class="container"><div class="content-shop">';
	}
}

if ( ! function_exists( 'rrm_content_wrapper_after' ) ) {
	/**
	 * Sorting wrapper close
	 *
	 * @since   1.4.3
	 * @return  void
	 */
	function rrm_content_wrapper_after() {
		echo '</div></div>';
	}
}

if ( ! function_exists( 'storefront_sidebar_product_search' ) ) {
	/**
	 * Display Product Search
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	function storefront_sidebar_product_search() {
		if ( storefront_is_woocommerce_activated() ) {
			?>
			<div class="site-sidebar-search">
				<h2>
					<?php esc_html_e( 'Search', 'storefront' ); ?>
				</h2>
				<?php the_widget( 'WC_Widget_Product_Search', 'title=' ); ?>
			</div>
			<?php
...
if ( ! function_exists( 'woocommerce_template_loop_product_wrapper_information_open' ) ) {
	/**
	 * Insert the opening anchor tag for products in the loop.
	 */
	function woocommerce_template_loop_product_wrapper_information_open() {
        ?>
...
if ( ! function_exists( 'woocommerce_template_loop_product_wrapper_information_close' ) ) {
	/**
	 * Insert the opening anchor tag for products in the loop.
	 */
	function woocommerce_template_loop_product_wrapper_information_close() {
		?>
		</div>
		<?php
	}
