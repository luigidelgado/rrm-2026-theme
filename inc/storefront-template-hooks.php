...
//add_action( 'storefront_header', 'rr_subheader', 0 );
//add_action( 'storefront_header', 'rr_header', 1 );
...
add_action( 'rr_hook_footer', 'rr_footer', 21 );
...
/* Add share section before comments */
add_action( 'storefront_single_post_bottom', 'rrm_share', 17 );
/* Add tags section before comments */
add_action( 'storefront_single_post_bottom', 'rrm_tags', 18 );
/* Add pagination section before comments */
add_action( 'storefront_single_post_bottom', 'rrm_pagination', 19 );
