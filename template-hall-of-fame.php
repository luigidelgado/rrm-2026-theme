...
<div class="container">
	...
	<div class="hall-of-fame">
		<section class="hall-of-fame-image desktop">
			<?php
			/*
			<img src="<? echo get_template_directory_uri().'/assets/images/hall_of_fame/logoshall.png'; ?>"
			alt=""> */
			?>
		...
		<section class="hall-of-fame-image mobile">
			<?php
			/*
			<img src="<? echo get_template_directory_uri().'/assets/images/hall_of_fame/logo_hof.png'; ?>"
			alt=""> */
			?>
