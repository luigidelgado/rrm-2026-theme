...
<div class="container">
	<div class="header-filter-category">
		<?php dynamic_sidebar( 'bottom-header-shop' ); ?>
	</div>
</div>

<?php
do_action( 'woocommerce_rrm_before_main_content' );
...
?>
<aside>
	<?php do_action( 'woocommerce_rrm_before_sidebar' ); ?>
	<?php get_sidebar( 'primary' );  ?>
</aside>
<?php

do_action( 'woocommerce_rrm_after_main_content' );
