...
<div class="container">
    <section class="contact">
        ...
        <div class="contact--right">
            ...
            <a href="https://wa.me/<?php echo $whatsappContacto; ?><?php if($whatsappTextoContacto != ""): echo "?text=".$whatsappTextoContacto; endif;?> " target="_blank" 
            ...
            <a href="https://wa.me/<?php echo $whatsappContacto; ?><?php if($whatsappTextoContacto != ""): echo "?text=".$whatsappTextoContacto; endif;?> " target="_blank" class="banner-whatsapp">
                <div>
                    Envíanos WhatsApp
                </div>
                <div>
