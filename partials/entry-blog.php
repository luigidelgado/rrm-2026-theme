<article class="archive-post">
	...
	<div class="archive-post__info">
		<a class="archive-post__title" href="<?php echo $args['url-post']; ?>">
			<h2>
				<?php echo $args['title']; ?>
			</h2>
		</a>
		...
		<?php endif; ?>
		<a class="archive-post__button" href="<?php echo $args['url-post']; ?>">
			Leer más
		</a>
	</div>
