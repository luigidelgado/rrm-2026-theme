<a class="gallery-item" data-src="<?php echo $args['url-image']; ?>" 
    data-sub-html="<?php echo $args['title-image']; ?> <?php if($args['description-image']): echo '<p>'.htmlspecialchars(strip_tags($args['description-image'])).'</p>'; endif;?> <?php if($args['destination-parent']): echo '<br />'.htmlspecialchars(strip_tags($args['destination-parent'])); endif; ?> <?php if($args['destination-child']): echo '<br />'.htmlspecialchars(strip_tags($args['destination-child'])); endif; ?> <?php echo '<br />'.htmlspecialchars(strip_tags($args['name-challengue']));?>"
    >
