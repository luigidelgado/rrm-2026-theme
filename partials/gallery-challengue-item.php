<div class="tab-challengue">
    ...
    <!-- Colocar  la imagen principal, es decir la que sale en la página -->
        ...
        <img 
            ...
            data-sub-html="<?php echo esc_attr($value['content-title']); ?> <?php if($value['content-description']): echo '<p>'.strip_tags(esc_attr($value['content-description'])).'</p>'; endif; ?> <?php if($value['destination-parent']): echo '<br />'.$value['destination-parent']; endif; ?> <?php if($value['destination-child']): echo '<br />'.$value['destination-child']; endif; ?>"
