...
if(isset($post_obj['my_account_submit']))
{
    ...
    $isupdate = update_user_meta( $current_user->ID,'first_name',sanitize_text_field($post_obj['first_name']));
    $isupdate = update_user_meta( $current_user->ID,'last_name',sanitize_text_field($post_obj['last_name']));
...
<div class="pm-section pm-dbfl" id="pg-settings-container">
 ...
 <div class="pm-section-left-panel">
