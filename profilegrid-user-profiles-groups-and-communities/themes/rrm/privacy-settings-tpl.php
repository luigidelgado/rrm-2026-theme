        ...
        <div class="pm-col">
            ...
            <div class="pm-field-input pm_required">
                <select name="pm_profile_privacy" id="pm_profile_privacy">
                    ...
                    <?php /*<option value="2" <?php selected($pmrequests->profile_magic_get_user_field_value($uid,'pm_profile_privacy'),2);?>><?php esc_html_e('Friends','profilegrid-user-profiles-groups-and-communities');?></option>
