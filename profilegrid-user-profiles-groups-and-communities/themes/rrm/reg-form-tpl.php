...
<div class="container">
    ...
    if ( is_user_logged_in() && $group_member && !has_action('profilegrid_group_register_onlogin')) : ?>
        ...
        ?> 
        <div class="pmagic rrm"> 
        <div class="pm-login-box pm-dbfl pm-radius5 pm-border"> 
        <div class="pm-login-header pm-dbfl pm-border-bt">
    ...
    <div class="pmagic rrm register">  
        ...
        <div class="pg-group-box-wrap pg-group-reg-form pm-dbfl">
            <form class="pmagic-form pm-dbfl" method="post" action="" id="pm_regform_<?php echo esc_attr($gid); ?>" name="pm_regform_<?php echo esc_attr($gid); ?>" onsubmit="return profile_magic_frontend_validation(this)" enctype="multipart/form-data">
                <?php /*<a class="session-init" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>">Iniciar Sesión</a> */ ?>
                <div class="pmagic-session-init">¿Ya tienes una cuenta? <a class="session-init" href="<?php echo site_url( '/iniciar-sesion/', 'https' ); ?>"> Inicia sesión aquí</a></div>
                <?php
                ...
                <div class="buttonarea pm-full-width-container">
                    ...
                    */
                    ...
                    <?php endif;  } endif; ?>
                        <input type="submit" value="<?php esc_attr_e('Register','profilegrid-user-profiles-groups-and-communities');?>" name="reg_form_submit">
                    </div>
            </form>
        </div>
    </div>
