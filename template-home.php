...
<div id="rr_home">
    <section id="slider-top">
        <?php
            if ($sliderHome) : foreach ($sliderHome as $slideH) :
    ...
    <?php 
        ...
        $parent_terms = wp_get_post_terms( $post_id, $taxonomy, array( 'parent' => 0, 'hide_empty' => false) );
        ...
        if ( !empty( $parent_terms ) ) {
             ...
             foreach ( $parent_terms as $parent_term ) {
                 ...
                 $child_terms = wp_get_post_terms( $post_id, $taxonomy, array( 'parent' => $parent_term->term_id, 'hide_empty' => false) );
            ...
            <div class="content_salon">
                ...
                <div class="right_content">
                    ...
                    <div class="slider_salon">
                        ...
                        <?php 
                        if ($salonFama) : foreach ($salonFama as $sf) :
    ...
    <section id="home_recorriendo">
        <div class="container">
            ...
            <div class="center_content">
                <?php 
                    if ($desafios) : foreach ($desafios as $desafio) :
            ...
            <div class="content_pasion">
                ...
                <div class="right_content">
                    ...
                    $args = array(
                      ...
                      if ($postsArray) :
						foreach ($postsArray as $post) : setup_postdata($post);
